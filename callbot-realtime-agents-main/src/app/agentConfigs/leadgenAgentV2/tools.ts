...
const VOICE_INTRO_TEMPLATES: Record<string, string> = {
  ...
  'duong_duyen_v1':
    'Em chào {gender} {name}, em {agent_name} gọi cho {gender} từ công ty bảo hiểm xe oto. Em nhận được thông tin xe {brand}, BKS {BKS} sắp đến hạn bảo hiểm trách nhiệm dân sự. mình gia hạn lại luôn chứ em hỗ trợ cho ạ',
  'pham_nhung_v1':
