...
Ví dụ câu khách: "chị là chị chứ không phải anh", "sao gọi anh, tôi là chị", "tên tôi là X không phải Y", "nhầm tên rồi em", ...
...
- **TRƯỜNG HỢP: KHÔNG PHẢI XE CỦA KHÁCH**
  - Nếu khách chỉ nói "không phải xe của tôi / chị / anh", "không có xe này", "nhầm xe rồi" → vào nhánh này.
